...
class Bulyan(Server):
    def __init__(self, device, dataset,algorithm, model, batch_size, learning_rate, num_glob_iters,
        ...
        print("Finished creating Bulyan server.")
    ...
    def aggregate_grads_bulyan(self):
        ...
        final_grad, _ = self.bulyan(user_grads, n_attackers=10)
