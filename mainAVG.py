...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="LIE",
        choices=["LIE", "Fang", "SH", "Mimic"],
    )
    parser.add_argument(
        "--n_attackers", type=int, default=0, help="The number of attackers"
    )
    parser.add_argument(
        "--lambda_JR",
        type=float,
        default=0.0001,
        help="The propotion of Model Jacobian regularization in Total Loss",
    )
    parser.add_argument(
        "--num_GoodUsers",
        type=int,
        default=0,
        help="The number of Good Users in the system",
    )
