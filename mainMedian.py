...
def main(dataset, algorithm,batch_size, learning_rate, lamda, num_glob_iters,
    ...
    for i in range(times):
        ...
        # select algorithm
        if(algorithm == "Median"):
            server = Median(device, dataset, algorithm, model, batch_size, learning_rate,num_glob_iters, local_epochs, optimizer, numusers, i,n_attackers,attacker_type,lambda_JR,num_GoodUsers,iid)
        server.train()
        server.test()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="Median",) 
